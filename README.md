...
Este repositório contém a entrega final da solução desenvolvida para a empresa parceira **Biovalor**, a partir do MVP base de **Controle de Resíduos**, incrementado com as necessidades específicas da empresa.

**MVPs base utilizados:**
- Android: {{LINK_REPO_MVP_ANDROID}}
- Java: {{LINK_REPO_MVP_JAVA}}
- Nuvem: {{LINK_REPO_MVP_NUVEM}}

## 🏢 Empresa parceira

| Campo | Informação |
|---|---|
| **Razão social** | Biovalor Limitada |
| **Nome fantasia** | Biovalor |
| **Segmento** | Indústria |
| **Cidade/UF** | Fortaleza/CE |
| **Supervisor do projeto** | Enio Giuliano Girão — Sócio |
